    ...
    <div class="layui-row">
        <form class="layui-form" id="menu-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="menuLevel" name="menuLevel" class="valid">
                        <#list menuLevelDictList as menuLevelDict>
                            <option value="${menuLevelDict.dictKey}">${menuLevelDict.dictValue}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="menuUrl" name="menuUrl" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" placeholder="请填写菜单地址">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="menuIcon" name="menuIcon" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" placeholder="请填写菜单图标">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    例: left-nav-li
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="parentMenuNo" name="parentMenuNo" class="valid">
                        <option value="0">无</option>
                        <#list parentAdminMenuList as parentAdminMenu>
                            <option value="${parentAdminMenu.menuNo}">${parentAdminMenu.menuName}</option>
                        </#list>
                    </select>
                </div>
            </div>

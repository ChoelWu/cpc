...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" id="cate-form">
            <input type="hidden" name="courseTagId" value="${indexCourseTag.courseTagId}">
            <div class="layui-form-item" style="margin-top: 30px;">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="courseTagName" name="courseTagName" required=""
                           ...
                           value="${indexCourseTag.courseTagName}">
                </div>
            </div>
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.verify({
            cateTagName: function (value, item) {
                ...
                if (value.length > 16) {
                    return '课程标签名不能超过16字符';
                }
                var checkRel = checkCourseTagName("${indexCourseTag.courseTagNo}", value);

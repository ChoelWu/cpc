...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            <input type="hidden" name="authId" value="${adminAuth.authId}">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="authName" name="authName" required="" lay-verify="required|textValidation"
                           autocomplete="off" class="layui-input" placeholder="请输入权限名称" value="${adminAuth.authName}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="authPermission" name="authPermission" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" placeholder="请输入权限规则" value="${adminAuth.authPermission}">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    不超过20个字符
                </div>

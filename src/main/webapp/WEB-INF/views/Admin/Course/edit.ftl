    ...
    <div class="layui-row">
        <form class="layui-form">
            <div class="layui-form-item">
                <input type="hidden" name="courseId" value="${indexCourse.courseId}">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="courseName" name="courseName" required="" lay-verify="required|courseName"
                           autocomplete="off" class="layui-input" placeholder="请输入课程标题"  value="${indexCourse.courseName}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="courseAuthor" name="courseAuthor" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" placeholder="请输入课程讲师" value="${indexCourse.courseAuthor}">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    不超过16字符，不能使用特殊字符
                </div>
                ...
                <div class="layui-input-inline">
                    <select id="courseDifficultLevel" name="courseDifficultLevel" class="valid" lay-verify="required">
                        <#list courseDifficultLevelAdminDictList as courseDifficultLevelAdminDict>
                            <option value="${courseDifficultLevelAdminDict.dictKey}" <#if courseDifficultLevelAdminDict.dictKey=indexCourse.courseDifficultLevel>selected</#if>>${courseDifficultLevelAdminDict.dictValue}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="courseFitPeople" name="courseFitPeople" required="" lay-verify="required|courseName"
                           autocomplete="off" class="layui-input" placeholder="请输入课程适宜人群"  value="${indexCourse.courseFitPeople}">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    不超过16字符，不能使用特殊字符
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <#list courseRoleAdminDictList as courseRoleAdminDict>
                        <input type="checkbox" value="${courseRoleAdminDict.dictKey}" title="${courseRoleAdminDict.dictValue}" lay-filter="role" <#if indexCourse.role?contains(courseRoleAdminDict.dictKey)>checked</#if>>
                    </#list>
                </div>
                <input type="hidden" id="roleHidden" name="role" value="${indexCourse.role}">
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">课程时长</label>
                <div class="layui-input-inline" style="width: 100px;">
                    <input type="text" name="courseDurationHour" autocomplete="off" class="layui-input" value="${indexCourse.courseDurationHour}">
                </div>
                <div class="layui-form-mid">小时 </div>
                <div class="layui-input-inline" style="width: 100px;">
                    <input type="text" name="courseDurationMinute" autocomplete="off" class="layui-input" value="${indexCourse.courseDurationMinute}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="publishTime" name="publishTime" id="publishTime" required=""
                           lay-verify="required" value="${indexCourse.publishTime?string('yyy-MM-dd')}"
                ...
                <div class="layui-input-inline">
                    <select id="isTop" name="isTop" class="valid" lay-verify="required">
                        <#list courseIsTopAdminDictList as courseIsTopAdminDict>
                            <option value="${courseIsTopAdminDict.dictKey}" <#if courseIsTopAdminDict.dictKey=indexCourse.isTop>selected</#if>>${courseIsTopAdminDict.dictValue}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-upload">
                    ...
                    <div class="layui-upload-list" style="padding-left: 110px;">
                        <img class="layui-upload-img" id="coverPic" <#if indexCourse.courseCover?? || "" = indexCourse.courseCover>src="${indexCourse.courseCover}" style="height: 100px;"</#if>>
                        <img class="layui-upload-img" id="coverPic">
                        <p id="demoText"></p>
                    </div>
                </div>
                <input type="hidden" name="courseCover" id="courseCover" value="${indexCourse.courseCover}">
            </div>
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="courseIntro" name="courseIntro"
                              class="layui-textarea">${indexCourse.courseIntro}</textarea>
                </div>
            </div>
            <div class="layui-form-item layui-form-text">

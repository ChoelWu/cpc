...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            <input type="hidden" name="lessonId" value="${indexLesson.lessonId}">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="lessonName" name="lessonName" required="" lay-verify="required|lessonName"
                           autocomplete="off" class="layui-input" placeholder="请输入课时名称" value="${indexLesson.lessonName}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="lessonIndex" name="lessonIndex" required="" lay-verify="required|lessonIndex"
                           autocomplete="off" class="layui-input" placeholder="请输入课时序号"  value="${indexLesson.lessonIndex}">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    序号越小排序越靠前
                </div>
                ...
                <div class="layui-input-inline">
                    <select id="lessonType" name="lessonType" class="valid">
                        <#list lessonTypeAdminDictList as lessonTypeAdminDict>
                            <option value="${lessonTypeAdminDict.dictKey}" <#if lessonTypeAdminDict.dictKey=indexLesson.lessonType>selected</#if>>${lessonTypeAdminDict.dictValue}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-upload">
                    <button type="button" class="layui-btn" id="multipartVideo">重新上传</button>
                    <div class="layui-upload-list" style="padding-left: 110px;">
                        <p id="multipartVideoText"></p>
                    </div>
                </div>
                <input type="hidden" name="lessonVideo" id="lessonVideo" value="${indexLesson.lessonVideo!''}">
            </div>
            <div class="layui-form-item">
                <label for="multipartSwf" class="layui-form-label">动画文件</label>
                <div class="layui-upload">
                    <button type="button" class="layui-btn layui-btn-danger" id="multipartSwf">重新上传</button>
                    <div class="layui-upload-list" style="padding-left: 110px;">
                        <p id="multipartSwfText"></p>
                    </div>
                </div>
                <input type="hidden" name="lessonSwf" id="lessonSwf" value="${indexLesson.lessonSwf!''}">
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layer', 'jquery', 'upload'], function () {
        ...
        var uploadInst = upload.render({
            ...
            ext: 'mp4',
            data: {
                courseNo: "${indexLesson.courseNo}",
                chapterNo: "${indexLesson.chapterNo}",
            },
            before: function (obj) {
                //loading层

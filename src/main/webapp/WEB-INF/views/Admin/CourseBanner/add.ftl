    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="courseBannerUrl" name="courseBannerUrl" required="" lay-verify="required|courseBannerUrl"
                           autocomplete="off" class="layui-input" placeholder="请输入课程推荐位名称">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <label for="courseBannerCover" class="layui-form-label">推荐位封面</label>
...
<script>
    layui.use(['form', 'layer', 'jquery', 'laydate', 'upload'], function () {
        ...
        var uploadInst = upload.render({
            ...
            before: function (obj) {
                ...
                $("#courseBannerCover").val(res.data);
    ...
    function checkcourseBannerName(courseBannerNo, courseBannerName) {
        var rel = false;
        $.ajax({
            url: '/admin/course_banner/check_course_banner.do',
            type: 'post',
            async: false,
            data: {

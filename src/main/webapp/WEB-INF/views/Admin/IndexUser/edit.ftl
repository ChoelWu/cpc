...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            <input type="hidden" name="userId" value="${indexUser.userId}">
            <div class="layui-form-item">
                <label for="userName" class="layui-form-label">
                    <span class="x-red">*</span>用户名</label>
                <div class="layui-input-inline">
                    <input type="text" id="userName" name="userName" required="" lay-verify="required|userName"
                           autocomplete="off" class="layui-input" placeholder="请输入用户名" value="${indexUser.userName}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="userAccount" name="userAccount" required="" lay-verify="required|userAccount"
                           autocomplete="off" value="${indexUser.userAccount}"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="userEmail" name="userEmail" required="" lay-verify="required|email|userEmail"
                           autocomplete="off" value="${indexUser.userEmail}"
                           class="layui-input" placeholder="请输入电子邮箱">
                </div>
                <div class="layui-form-mid layui-word-aux">不超过50个字符</div>
            </div>
            <div class="layui-form-item">
                <label for="userMobile" class="layui-form-label">用户电话</label>
                <div class="layui-input-inline">
                    <input type="text" id="userMobile" name="userMobile" required="" lay-verify="required|phone"
                           autocomplete="off" class="layui-input" placeholder="请输入 11 的位用户电话"
                           value="${indexUser.userMobile}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="userType" name="userType" class="valid">
                        <#list userTypeAdminDictList as userTypeAdminDict>
                            <option value="${userTypeAdminDict.dictKey}"
                                    <#if userTypeAdminDict.dictKey=indexUser.userType>selected</#if>>${userTypeAdminDict.dictValue}</option>
                        </#list>
                    </select>
                </div>
            </div>
    ...
    layui.use(['form', 'layer', 'jquery'], function () {
        ...
        form.verify({
            userName: function (value) {
                ...
                var checkRel = checkUser("${indexUser.userNo}", "user_name", value);
            ...
            userAccount: function (value) {
                ...
                var checkRel = checkUser("${indexUser.userNo}", "user_account", value);
                if ("false" === checkRel || !checkRel) {
                    return '用户账户不能重复！';
                }
            },
            userEmail: function (value) {
                var checkRel = checkUser("${indexUser.userNo}", "user_email", value);
                if ("false" === checkRel || !checkRel) {
                    return '此邮箱已经被使用！';
                }
            }

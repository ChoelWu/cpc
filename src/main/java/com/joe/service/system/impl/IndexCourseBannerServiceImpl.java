...
public class IndexCourseBannerServiceImpl extends ServiceImpl<IndexCourseBannerMapper, IndexCourseBanner> implements IndexCourseBannerService {
     ...
     * @return 返回查询结果
     */
    public int countCourseBanner(Map<String, Object> conditions) {
     ...
     * @return 返回查询结果
     */
    public List<IndexCourseBanner> listCourseBanner(Map<String, Object> conditions, Map<String, Integer> pageInfo) {
        if(null == conditions || conditions.isEmpty()) {
            conditions = Maps.newHashMap();
            conditions.put("1", "2");
        }
